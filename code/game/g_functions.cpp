...
#define TOUCHCASE(blah)           \
	case touchF_##blah:           \
		blah(self, other, trace); \
		break;
...
#define PAINCASE(blah)                                               \
	case painF_##blah:                                               \
		blah(self, inflictor, attacker, point, damage, mod, hitLoc); \
		break;
...
#define DIECASE(blah)                                                 \
	case dieF_##blah:                                                 \
		blah(self, inflictor, attacker, damage, mod, dFlags, hitLoc); \
		break;
