...
{
	if (v1[0] > v2[0] + 0.0001f || v1[0] < v2[0] - 0.0001f || v1[1] > v2[1] + 0.0001f || v1[1] < v2[1] - 0.0001f || v1[2] > v2[2] + 0.0001f || v1[2] < v2[2] - 0.0001f)
	{
		return 0;
	}
	return 1;
...
//JLF MPMOVED
#define CVAR_PROFILE 2048 //used to mark profile cvars.
