...
struct ModelContainer
{
	...
	//
	LPCSTR (*pModelInfoFunction)
	(ModelHandle_t hModel);
	LPCSTR (*pModelGetBoneNameFunction)
	(ModelHandle_t hModel, int iBoneIndex);
	LPCSTR (*pModelGetBoneBoltNameFunction)
	(ModelHandle_t hModel, int iBoltIndex); // same as above in GLM model
	LPCSTR (*pModelGetSurfaceNameFunction)
	(ModelHandle_t hModel, int iSurfaceIndex);
	LPCSTR (*pModelGetSurfaceBoltNameFunction)
	(ModelHandle_t hModel, int iSurfaceIndex); // same as above in GLM model
};
